...
async function handlegenerateNewShortURL(req, res) {
   ...
   await URL.create({
      ...
      visitHistory: [],
      CREATEBY:req.user.id,//map se liya mongo bd ke user ki id kyonki apne unique id and user login karne wale ki detail map main bhej diyaa setuser() map function ki help se
   }); 
